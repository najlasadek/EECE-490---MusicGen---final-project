...
def train_or_resume(midi_folder: str, save_dir: str, num_epochs: int = 1000, batch_size: int = 64, 
                    learning_rate: float = 0.001, sequence_length: int = 100):
    processor = PianoRollProcessor()
    trainer = MusicTrainer(processor, sequence_length)
...
if __name__ == "__main__":
    midi_folder = "data/"  # Replace with your MIDI folder path
    save_dir = "models/"  # Replace with the directory where you want to save the models
    train_or_resume(midi_folder, save_dir, num_epochs=70, batch_size=64, learning_rate=0.001, sequence_length=100)
